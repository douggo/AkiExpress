...
--
-- Host: localhost
-- Tempo de geração: 29/09/2017 às 00:26
...
--
-- Banco de dados: `api_ecommerce`
--
DROP DATABASE IF EXISTS `api_ecommerce`;
CREATE DATABASE IF NOT EXISTS `api_ecommerce` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `api_ecommerce`;
...
(1, 'marcondes', '111.111.111-11', 'marcondesmacaneiro@gmail.com', '61f4e6275209493e5cdd0e47e4ff2441');
